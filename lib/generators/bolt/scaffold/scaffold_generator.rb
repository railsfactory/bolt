module Bolt
  class ScaffoldGenerator < Rails::Generators::NamedBase
    ...
    def generate_files
      ...
      template 'controller.rb', "app/controllers/bolt/#{plural_name}_controller.rb"
      template 'views/index.html.erb', "app/views/bolt/#{plural_name}/index.html.erb"
      template 'views/show.html.erb', "app/views/bolt/#{plural_name}/show.html.erb"
      template 'views/new.html.erb', "app/views/bolt/#{plural_name}/new.html.erb"
      template 'views/_form.html.erb', "app/views/bolt/#{plural_name}/_form.html.erb"
      template 'views/_table.html.erb', "app/views/bolt/#{plural_name}/_table.html.erb"
  ...
  protected
    ...
    def add_namespace_to_routes
      puts "   bolt     adding namespace to routes.rb"
      file_to_update = Rails.root + 'config/routes.rb'
      line_to_add = "namespace :bolt do"
    ...
    def add_to_routes
      puts "   bolt     adding #{plural_name} resources to routes.rb"
      file_to_update = Rails.root + 'config/routes.rb'
      line_to_add = "resources :#{plural_name}"
      insert_sentinel = 'namespace :bolt do'
      gsub_add_once plural_name, file_to_update, "\t\t" + line_to_add, insert_sentinel
    end

    def add_to_navigation
      puts "   bolt     adding #{plural_name} to left navigation bar"
      file_to_update = Rails.root + 'app/views/bolt/layouts/_left_navigation.html.erb'
      line_to_add = "<li id=\"visitSite\"><%= link_to \"#{plural_name.humanize.capitalize}\", bolt_#{@plural_route}_path %></li>"
